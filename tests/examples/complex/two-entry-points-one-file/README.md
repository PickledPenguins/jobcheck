...
The second entry point loads only `hard_checks` and validates its own frame. Run
...
Expected: a registry holding only base and hard_checks tests, and two rows' results; exit 0
